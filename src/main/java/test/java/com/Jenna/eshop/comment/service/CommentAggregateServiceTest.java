...
public class CommentAggregateServiceTest {
    ...
    public void testSaveCommentAggregate() throws Exception {
        ...
        assertEquals(Long.valueOf(1L), resultCommentAggregateDO.getTotalCommentCount());  //new Long(1L) 在JDK19被替代为 Long.valueOf(1L)
    ...
    private CommentAggregateDO createCommentAggregateDO(Long goodsId) throws Exception {
        ...
        commentAggregateDO.setGoodsId(1L);
        commentAggregateDO.setId(goodsId);
