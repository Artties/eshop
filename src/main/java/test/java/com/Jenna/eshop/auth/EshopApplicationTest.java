package test.java.com.Jenna.eshop.auth;
...
public class EshopApplicationTest {
	...
	public static void main(String[] args) {
		SpringApplication.run(EshopApplicationTest.class, args);
		
		SpringApplication app = new SpringApplication(EshopApplicationTest.class);
