...
public class ShoppingCartDO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShoppingCartDO)) {
            return false;
        }
...
//
//        if(gmtCreate == null){
//            if (other.gmtCreate != null) {return false;}
//            else if (!gmtCreate.equals(other.gmtCreate)) {return false;}
//        }
//        if(gmtModified == null){
//            if (other.gmtModified != null) { return false;}
//            else if (!gmtModified.equals(other.gmtModified)) { return false; }
//        }
//        if(id == null){
...
//            if (other.userAccountId != null) {return false;}
//            else if (!userAccountId.equals(other.userAccountId)){return false;}
//        }
//        return true;
//    }
//
